...
const CLASSES = [
  {
    ...
    sessions: [
      { day_of_week: 2, start_time: '16:10:00', end_time: '18:00:00', location: '331 Uris Hall' },
    ],
  },
  {
    ...
    sessions: [
      { day_of_week: 1, start_time: '16:10:00', end_time: '18:00:00', location: '331 Uris Hall' },
    ],
  },
  {
  ...
  },
  {
    ...
    sessions: [
      { day_of_week: 3, start_time: '18:10:00', end_time: '20:00:00', location: '140 Uris Hall' },
    ],
  },
];
...
serve(async (req) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ success: true, classes: createdClasses }), {
      headers: { ...corsHeaders, 'Content-Type': 'application/json' },
    });
  } catch (error) {
